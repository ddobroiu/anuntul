...
export const blogPosts: BlogPost[] = [
    ...
    {
        id: '7',
        slug: 'alegere-furnizor-materiale-vizibilitate-pnrr',
        title: 'Cum să alegi corect furnizorul de materiale de vizibilitate pentru proiectul tău PNRR',
        excerpt: 'Criterii esențiale pentru selectarea unei tipografii care să asigure conformitatea 100% cu Manualul de Identitate Vizuală și să evite respingerea cheltuielilor.',
        content: `
            <p>Implementarea unui proiect prin Planul Național de Redresare și Reziliență (PNRR) este o oportunitate imensă, dar și o responsabilitate administrativă pe măsură. Unul dintre capitolele care dau cele mai multe bătăi de cap beneficiarilor este cel de <strong>vizibilitate</strong>.</p>
            
            <h3>Importanța expertizei în MIV</h3>
            <p>Nu orice tipografie poate realiza materiale conforme pentru fonduri europene. Manualul de Identitate Vizuală (MIV) este extrem de specific în privința culorilor (coduri CMYK și Pantone), a zonelor de protecție și a ierarhiei logourilor. O eroare de câțiva milimetri poate duce la declararea cheltuielii ca neeligibilă.</p>
            
            <p>Recomandăm colaborarea cu specialiști precum echipa de la <strong><a href="https://euprint.ro" target="_blank">EuPrint.ro</a></strong>, care deține o vastă experiență în kituri de vizibilitate PNRR și REGIO, oferind garanție de conformitate pentru fiecare produs livrat.</p>

            <h3>Durabilitate și Calitate Premium</h3>
            <p>Materialele de vizibilitate, cum ar fi panourile temporare sau plăcile permanente, trebuie să reziste pe toată durata de monitorizare a proiectului (adesea 5 ani). Printul UV pe materiale rigide este singura soluție care garantează că mesajul nu se va decolora sub acțiunea razelor solare.</p>
