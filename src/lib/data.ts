...
export const dummyArticles: Article[] = [
    ...
    {
        id: 'comunicat-de-presa-finalizare-bradet',
        title: 'Comunicat de presă finalizare — BRADET',
        excerpt: 'Comunicat de presă în format PDF. Click pentru a vizualiza documentul complet.',
        content: '',
        category: 'Comunicat',
        region: 'National',
        date: '30.07.2026',
        imageUrl: 'https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?q=80&w=2070&auto=format&fit=crop',
        pdfUrl: '/comunicate/comunicat de presa_finalizare_BRADET.pdf',
        isFeatured: false,
    },
    {
        id: 'comunicat-de-presa-finalizare-lactate-bradet',
        title: 'Comunicat de presă finalizare — LACTATE BRADET',
        excerpt: 'Comunicat de presă în format PDF. Click pentru a vizualiza documentul complet.',
        content: '',
        category: 'Comunicat',
        region: 'National',
        date: '30.07.2026',
        imageUrl: 'https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?q=80&w=2070&auto=format&fit=crop',
        pdfUrl: '/comunicate/comunicat de presa_finalizare_LACTATE BRADET.pdf',
        isFeatured: false,
    },
    {
