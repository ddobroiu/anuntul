...
export const FONDURI_DATA: Record<string, LandingInfo> = {
  ...
  "pnrr": {
    ...
    seoTitle: "Kit Vizibilitate PNRR | Placi si Autocolante | ShopPrint",
  ...
  "digitalizare-imm": {
    ...
    seoTitle: "Vizibilitate PNRR Digitalizare IMM | Autocolante Laptop | ShopPrint",
  ...
  "placa-permanenta-pnrr": {
    ...
    seoTitle: "Placa Permanenta PNRR | Panou Vizibilitate | ShopPrint",
  ...
  "start-up-nation": {
    ...
    seoTitle: "Placa Start-Up Nation | Kit Vizibilitate | ShopPrint",
  ...
  "femeia-antreprenor": {
    ...
    seoTitle: "Placa Femeia Antreprenor | Vizibilitate Proiect | ShopPrint",
  ...
  "regio": {
    ...
    seoTitle: "Panou Temporar Regio | POR Vizibilitate | ShopPrint",
  ...
  "panou-temporar": {
    ...
    seoTitle: "Panou Temporar Investitie | Fonduri Europene | ShopPrint",
  ...
  "pnrr-sanatate": {
    ...
    seoTitle: "Kit PNRR Sanatate | Vizibilitate Proiecte Medicale | ShopPrint",
  ...
  "pnrr-educatie": {
    ...
    seoTitle: "Kit PNRR Educatie | Vizibilitate Scolara | ShopPrint",
  ...
  "pnrr-transport": {
    ...
    seoTitle: "Kit PNRR Transport | Vizibilitate Infrastructura | ShopPrint",
  ...
  "pnrr-agricultura": {
    ...
    seoTitle: "Kit PNRR Agricultura | Vizibilitate Fermieri | ShopPrint",
  ...
  "pnrr-energie": {
    ...
    seoTitle: "Kit PNRR Energie | Vizibilitate Verda | ShopPrint",
  ...
  "pnrr-turism": {
    ...
    seoTitle: "Kit PNRR Turism | Vizibilitate Hoteluri | ShopPrint",
  ...
  "pnrr-digital": {
    ...
    seoTitle: "Kit PNRR Digital | Vizibilitate Tehnologie | ShopPrint",
  ...
  "pnrr-mediu": {
    ...
    seoTitle: "Kit PNRR Mediu | Vizibilitate Ecologica | ShopPrint",
  ...
  "pnrr-cultură": {
    ...
    seoTitle: "Kit PNRR Cultura | Vizibilitate Artistica | ShopPrint",
  ...
  "antreprenoriat": {
    ...
    seoTitle: "Kit Antreprenoriat | Vizibilitate Proiecte | ShopPrint",
  ...
  "inovare": {
    ...
    seoTitle: "Kit Inovare | Vizibilitate Tehnologica | ShopPrint",
  ...
  "agricultura-nationala": {
    ...
    seoTitle: "Kit Agricultura Nationala | Vizibilitate Fermieri | ShopPrint",
  ...
  "turism-national": {
    ...
    seoTitle: "Kit Turism National | Vizibilitate Destinatii | ShopPrint",
  ...
  "sanatate-nationala": {
    ...
    seoTitle: "Kit Sanatate Nationala | Vizibilitate Medicala | ShopPrint",
  ...
  "educatie-nationala": {
    ...
    seoTitle: "Kit Educatie Nationala | Vizibilitate Scolara | ShopPrint",
  ...
  "cultura-nationala": {
    ...
    seoTitle: "Kit Cultura Nationala | Vizibilitate Artistica | ShopPrint",
  ...
  "sport-national": {
    ...
    seoTitle: "Kit Sport National | Vizibilitate Atletica | ShopPrint",
  ...
  "mediu-national": {
    ...
    seoTitle: "Kit Mediu National | Vizibilitate Ecologica | ShopPrint",
  ...
  "transport-national": {
    ...
    seoTitle: "Kit Transport National | Vizibilitate Infrastructura | ShopPrint",
  ...
  "regio-sanatate": {
    ...
    seoTitle: "Panou Regio Sanatate | Vizibilitate Medicala | ShopPrint",
  ...
  "regio-educatie": {
    ...
    seoTitle: "Panou Regio Educatie | Vizibilitate Scolara | ShopPrint",
  ...
  "regio-transport": {
    ...
    seoTitle: "Panou Regio Transport | Vizibilitate Infrastructura | ShopPrint",
  ...
  "regio-agricultura": {
    ...
    seoTitle: "Panou Regio Agricultura | Vizibilitate Fermieri | ShopPrint",
  ...
  "regio-turism": {
    ...
    seoTitle: "Panou Regio Turism | Vizibilitate Destinatii | ShopPrint",
  ...
  "regio-mediu": {
    ...
    seoTitle: "Panou Regio Mediu | Vizibilitate Ecologica | ShopPrint",
  ...
  "regio-cultură": {
    ...
    seoTitle: "Panou Regio Cultura | Vizibilitate Artistica | ShopPrint",
  ...
  "regio-sport": {
    ...
    seoTitle: "Panou Regio Sport | Vizibilitate Atletica | ShopPrint",
  ...
  "regio-digital": {
    ...
    seoTitle: "Panou Regio Digital | Vizibilitate Tehnologica | ShopPrint",
  ...
  "regio-energie": {
    ...
    seoTitle: "Panou Regio Energie | Vizibilitate Verda | ShopPrint",
  ...
  "fonduri-structurale": {
    ...
    seoTitle: "Kit Fonduri Structurale | Vizibilitate Europeana | ShopPrint",
  ...
  "fonduri-cooperare": {
    ...
    seoTitle: "Kit Fonduri Cooperare | Vizibilitate Internationala | ShopPrint",
  ...
  "fonduri-inovare": {
    ...
    seoTitle: "Kit Fonduri Inovare | Vizibilitate Tehnologica | ShopPrint",
  ...
  "fonduri-startup": {
    ...
    seoTitle: "Kit Fonduri Startup | Vizibilitate Antreprenoriala | ShopPrint",
  ...
  "fonduri-ngo": {
    ...
    seoTitle: "Kit Fonduri ONG | Vizibilitate Comunitara | ShopPrint",
  ...
  "fonduri-educatie-superioara": {
    ...
    seoTitle: "Kit Fonduri Educatie Superioara | Vizibilitate Academica | ShopPrint",
  ...
  "fonduri-cercetare": {
    ...
    seoTitle: "Kit Fonduri Cercetare | Vizibilitate Stiintifica | ShopPrint",
  ...
  "fonduri-tineret": {
    ...
    seoTitle: "Kit Fonduri Tineret | Vizibilitate Juvenila | ShopPrint",
  ...
  "fonduri-femei": {
    ...
    seoTitle: "Kit Fonduri Femei | Vizibilitate Egalitate | ShopPrint",
  ...
  "fonduri-rural": {
    ...
    seoTitle: "Kit Fonduri Rurale | Vizibilitate Rurala | ShopPrint",
