...
export const PLIANTE_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "pizzerie": {
    ...
    seoTitle: "Pliante Pizzerie | Meniuri Delivery | ShopPrint",
  ...
  "restaurant": {
    ...
    seoTitle: "Pliante Restaurant & Catering | Tipar Meniuri | ShopPrint",
  ...
  "fast-food": {
    ...
    seoTitle: "Flyere Fast Food & Shaormerie | Promotie Stradala | ShopPrint",
  ...
  "imobiliare": {
    ...
    seoTitle: "Flyere Imobiliare | Caut Apartamente | ShopPrint",
  ...
  "curatenie": {
    ...
    seoTitle: "Pliante Firma Curatenie | Marketing Local | ShopPrint",
  ...
  "servicii-funerare": {
    ...
    seoTitle: "Pliante Servicii Funerare | Pompe Funebre | ShopPrint",
  ...
  "salon": {
    ...
    seoTitle: "Pliante Salon Infrumusetare | Lista Preturi | ShopPrint",
  ...
  "clinica": {
    ...
    seoTitle: "Pliante Clinica & Stomatologie | Brosuri Pacienti | ShopPrint",
  ...
  "electorale": {
    ...
    seoTitle: "Flyere Electorale | Pliante Campanie | ShopPrint",
  ...
  "evenimente": {
    ...
    seoTitle: "Flyere Evenimente & Party | Promovare Club | ShopPrint",
  ...
  "scoala": {
    ...
    seoTitle: "Pliante Scoala & Gradinita | Oferta Educationala | ShopPrint",
  ...
  "braserie": {
    ...
    seoTitle: "Pliante Brasserie | Meniu Bere | ShopPrint",
  ...
  "cafenea": {
    ...
    seoTitle: "Pliante Cafenea | Meniu Deserturi | ShopPrint",
  ...
  "gelaterie": {
    ...
    seoTitle: "Flyere Gelaterie | Inghetata Artizanala | ShopPrint",
  ...
  "catering": {
    ...
    seoTitle: "Pliante Catering | Evenimente | ShopPrint",
  ...
  "food-truck": {
    ...
    seoTitle: "Flyere Food Truck | Mancare Strada | ShopPrint",
  ...
  "reparatii-auto": {
    ...
    seoTitle: "Pliante Service Auto | Reparatii | ShopPrint",
  ...
  "it-service": {
    ...
    seoTitle: "Flyere IT Service | Programare | ShopPrint",
  ...
  "constructii": {
    ...
    seoTitle: "Pliante Constructii | Renovari | ShopPrint",
  ...
  "transport": {
    ...
    seoTitle: "Flyere Transport | Logistica | ShopPrint",
  ...
  "consultanta": {
    ...
    seoTitle: "Pliante Consultanta | Finante | ShopPrint",
  ...
  "coafura": {
    ...
    seoTitle: "Pliante Coafor | Frizerie | ShopPrint",
  ...
  "spa": {
    ...
    seoTitle: "Pliante SPA | Relaxare | ShopPrint",
  ...
  "farmacie": {
    ...
    seoTitle: "Flyere Farmacie | Produse Sanatate | ShopPrint",
  ...
  "dentist": {
    ...
    seoTitle: "Pliante Dentist | Stomatologie | ShopPrint",
  ...
  "optician": {
    ...
    seoTitle: "Flyere Optica | Ochelari | ShopPrint",
  ...
  "nunta": {
    ...
    seoTitle: "Flyere Nunti | Organizatori | ShopPrint",
  ...
  "botez": {
    ...
    seoTitle: "Pliante Botezuri | Evenimente | ShopPrint",
  ...
  "corporate": {
    ...
    seoTitle: "Flyere Corporate | Evenimente Afaceri | ShopPrint",
  ...
  "festival": {
    ...
    seoTitle: "Flyere Festivaluri | Concerte | ShopPrint",
  ...
  "sport": {
    ...
    seoTitle: "Pliante Sport | Evenimente | ShopPrint",
  ...
  "cursuri": {
    ...
    seoTitle: "Pliante Cursuri | Training | ShopPrint",
  ...
  "universitate": {
    ...
    seoTitle: "Flyere Universitate | Admitere | ShopPrint",
  ...
  "muzeu": {
    ...
    seoTitle: "Pliante Muzee | Cultura | ShopPrint",
  ...
  "teatru": {
    ...
    seoTitle: "Flyere Teatru | Spectacole | ShopPrint",
  ...
  "librarie": {
    ...
    seoTitle: "Pliante Librarie | Carte | ShopPrint",
  ...
  "hotel": {
    ...
    seoTitle: "Pliante Hotel | Cazare | ShopPrint",
  ...
  "agentie-turism": {
    ...
    seoTitle: "Flyere Agentie Turism | Vacante | ShopPrint",
  ...
  "parc": {
    ...
    seoTitle: "Pliante Parcuri | Distractie | ShopPrint",
  ...
  "zoo": {
    ...
    seoTitle: "Flyere Zoo | Animale | ShopPrint",
  ...
  "cinema": {
    ...
    seoTitle: "Pliante Cinema | Filme | ShopPrint",
  ...
  "avocat": {
    ...
    seoTitle: "Pliante Avocat | Drept | ShopPrint",
  ...
  "contabil": {
    ...
    seoTitle: "Flyere Contabil | Finante | ShopPrint",
  ...
  "asigurari": {
    ...
    seoTitle: "Pliante Asigurari | Protectie | ShopPrint",
  ...
  "banca": {
    ...
    seoTitle: "Flyere Banca | Credite | ShopPrint",
  ...
  "fitness": {
    ...
    seoTitle: "Pliante Fitness | Sport | ShopPrint",
