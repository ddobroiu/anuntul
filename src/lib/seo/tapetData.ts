...
export const TAPET_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "living": {
    ...
    seoTitle: "Tapet Living Modern | Fototapet Sufragerie | ShopPrint",
  ...
  "dormitor": {
    ...
    seoTitle: "Tapet Dormitor Matrimonial | Decor Perete | ShopPrint",
  ...
  "camera-copii": {
    ...
    seoTitle: "Tapet Camera Copii & Bebe | Fototapet | ShopPrint",
  ...
  "bucatarie": {
    ...
    seoTitle: "Tapet Bucatarie Lavabil | Decor Perete | ShopPrint",
  ...
  "hol": {
    ...
    seoTitle: "Tapet Hol & Intrare | Fototapet 3D | ShopPrint",
  ...
  "harta-lumii": {
    ...
    seoTitle: "Tapet Harta Lumii | Fototapet Harta | ShopPrint",
  ...
  "3d": {
    ...
    seoTitle: "Tapet 3D Living & Dormitor | Efect Adancime | ShopPrint",
  ...
  "texturi": {
    ...
    seoTitle: "Tapet Caramida & Beton | Stil Industrial | ShopPrint",
  ...
  "peisaje": {
    ...
    seoTitle: "Tapet Peisaje Natura | Fototapet Padure & Mare | ShopPrint",
  ...
  "birou": {
    ...
    seoTitle: "Tapet Birou & Office | Branding Pereti | ShopPrint",
  ...
  "cafenea": {
    ...
    seoTitle: "Tapet Horeca | Cafenea & Restaurant | ShopPrint",
  ...
  "salon": {
    ...
    seoTitle: "Tapet Salon & Spa | Decor Relaxant | ShopPrint",
  ...
  "gradinita": {
    ...
    seoTitle: "Tapet Gradinita & Loc de Joaca | ShopPrint",
  ...
  "nunta": {
    ...
    seoTitle: "Tapet Nunta & Evenimente | Fototapet Romantic | ShopPrint",
  ...
  "botez": {
    ...
    seoTitle: "Tapet Botez & Nastere | Decor Eveniment | ShopPrint",
  ...
  "zi-de-nastere": {
    ...
    seoTitle: "Tapet Zi de Nastere | Decor Petrecere | ShopPrint",
  ...
  "petrecere-copii": {
    ...
    seoTitle: "Tapet Petrecere Copii | Decor Magie | ShopPrint",
  ...
  "revelion": {
    ...
    seoTitle: "Tapet Revelion & An Nou | Decor Petrecere | ShopPrint",
  ...
  "halloween": {
    ...
    seoTitle: "Tapet Halloween | Decor Înfricosator | ShopPrint",
  ...
  "craciun": {
    ...
    seoTitle: "Tapet Craciun & Iarna | Decor Festiv | ShopPrint",
  ...
  "paste": {
    ...
    seoTitle: "Tapet Paste & Primavara | Decor Traditional | ShopPrint",
  ...
  "targ": {
    ...
    seoTitle: "Tapet Targ & Expo | Branding Perete | ShopPrint",
  ...
  "festival": {
    ...
    seoTitle: "Tapet Festival & Concert | Decor Muzical | ShopPrint",
  ...
  "conferinta": {
    ...
    seoTitle: "Tapet Conferinta & Seminar | Decor Business | ShopPrint",
  ...
  "petrecere-adulti": {
    ...
    seoTitle: "Tapet Petrecere Adulti | Decor Glamour | ShopPrint",
  ...
  "restaurant": {
    ...
    seoTitle: "Tapet Restaurant & Horeca | Decor Gastronomic | ShopPrint",
  ...
  "bar": {
    ...
    seoTitle: "Tapet Bar & Pub | Decor Relaxant | ShopPrint",
  ...
  "hotel": {
    ...
    seoTitle: "Tapet Hotel & Pensiune | Decor Confort | ShopPrint",
  ...
  "spital": {
    ...
    seoTitle: "Tapet Spital & Clinica | Decor Calmant | ShopPrint",
  ...
  "scoala": {
    ...
    seoTitle: "Tapet Scoala & Universitate | Decor Educational | ShopPrint",
  ...
  "magazin": {
    ...
    seoTitle: "Tapet Magazin & Butic | Decor Comercial | ShopPrint",
  ...
  "birou-corporate": {
    ...
    seoTitle: "Tapet Birou Corporate | Decor Office | ShopPrint",
  ...
  "fitness": {
    ...
    seoTitle: "Tapet Fitness & Sala Sport | Decor Motivational | ShopPrint",
  ...
  "coafura": {
    ...
    seoTitle: "Tapet Coafura & Salon | Decor Beauty | ShopPrint",
  ...
  "avocat": {
    ...
    seoTitle: "Tapet Cabinet Avocat | Decor Juridic | ShopPrint",
  ...
  "dentist": {
    ...
    seoTitle: "Tapet Cabinet Dentist | Decor Calmant | ShopPrint",
  ...
  "farmacie": {
    ...
    seoTitle: "Tapet Farmacie | Decor Medical | ShopPrint",
  ...
  "agentie-imobiliara": {
    ...
    seoTitle: "Tapet Agentie Imobiliara | Decor Lux | ShopPrint",
  ...
  "constructii": {
    ...
    seoTitle: "Tapet Firma Constructii | Decor Industrial | ShopPrint",
  ...
  "it": {
    ...
    seoTitle: "Tapet Firma IT | Decor Tech | ShopPrint",
  ...
  "marketing": {
    ...
    seoTitle: "Tapet Agentie Marketing | Decor Creativ | ShopPrint",
  ...
  "contabilitate": {
    ...
    seoTitle: "Tapet Cabinet Contabilitate | Decor Profesional | ShopPrint",
  ...
  "turism": {
    ...
    seoTitle: "Tapet Agentie Turism | Decor Aventura | ShopPrint",
  ...
  "auto": {
    ...
    seoTitle: "Tapet Service Auto | Decor Moto | ShopPrint",
  ...
  "electrice": {
    ...
    seoTitle: "Tapet Firma Electrica | Decor Tech | ShopPrint",
  ...
  "instalatii": {
    ...
    seoTitle: "Tapet Firma Instalatii | Decor Industrial | ShopPrint",
  ...
  "transport": {
    ...
    seoTitle: "Tapet Firma Transport | Decor Logistic | ShopPrint",
  ...
  "agricultura": {
    ...
    seoTitle: "Tapet Firma Agricultura | Decor Rural | ShopPrint",
  ...
  "veterinar": {
    ...
    seoTitle: "Tapet Cabinet Veterinar | Decor Animal | ShopPrint",
  ...
  "fotograf": {
    ...
    seoTitle: "Tapet Atelier Fotograf | Decor Artistic | ShopPrint",
  ...
  "arta": {
    ...
    seoTitle: "Tapet Atelier Arta | Decor Creativ | ShopPrint",
  ...
  "muzica": {
    ...
    seoTitle: "Tapet Studio Muzica | Decor Ritmic | ShopPrint",
  ...
  "dans": {
    ...
    seoTitle: "Tapet Scoala Dans | Decor Grațios | ShopPrint",
  ...
  "yoga": {
    ...
    seoTitle: "Tapet Studio Yoga | Decor Calmant | ShopPrint",
  ...
  "pilates": {
    ...
    seoTitle: "Tapet Studio Pilates | Decor Fitness | ShopPrint",
  ...
  "terapie": {
    ...
    seoTitle: "Tapet Cabinet Terapie | Decor Calmant | ShopPrint",
  ...
  "psiholog": {
    ...
    seoTitle: "Tapet Cabinet Psiholog | Decor Empatic | ShopPrint",
  ...
  "masaj": {
    ...
    seoTitle: "Tapet Salon Masaj | Decor Relaxant | ShopPrint",
  ...
  "tatuaj": {
    ...
    seoTitle: "Tapet Salon Tatuaj | Decor Artistic | ShopPrint",
  ...
  "bijuterii": {
    ...
    seoTitle: "Tapet Atelier Bijuterii | Decor Luxos | ShopPrint",
  ...
  "ceasuri": {
    ...
    seoTitle: "Tapet Atelier Ceasuri | Decor Tehnic | ShopPrint",
  ...
  "mobilier": {
    ...
    seoTitle: "Tapet Atelier Mobilier | Decor Artizanal | ShopPrint",
  ...
  "textile": {
    ...
    seoTitle: "Tapet Atelier Textile | Decor Colorat | ShopPrint",
  ...
  "ceramica": {
    ...
    seoTitle: "Tapet Atelier Ceramica | Decor Artizanal | ShopPrint",
  ...
  "sticla": {
    ...
    seoTitle: "Tapet Atelier Sticla | Decor Transparent | ShopPrint",
  ...
  "metal": {
    ...
    seoTitle: "Tapet Atelier Metal | Decor Industrial | ShopPrint",
  ...
  "electronice": {
    ...
    seoTitle: "Tapet Atelier Electronice | Decor Tech | ShopPrint",
  ...
  "robotica": {
    ...
    seoTitle: "Tapet Atelier Robotica | Decor Futurist | ShopPrint",
  ...
  "aviatie": {
    ...
    seoTitle: "Tapet Atelier Aviatie | Decor Aerian | ShopPrint",
  ...
  "naval": {
    ...
    seoTitle: "Tapet Atelier Naval | Decor Maritim | ShopPrint",
  ...
  "spatiu": {
    ...
    seoTitle: "Tapet Atelier Spatiu | Decor Cosmic | ShopPrint",
  ...
  "energie": {
    ...
    seoTitle: "Tapet Firma Energie | Decor Verde | ShopPrint",
  ...
  "apa": {
    ...
    seoTitle: "Tapet Firma Apa | Decor Fluid | ShopPrint",
  ...
  "reciclare": {
    ...
    seoTitle: "Tapet Firma Reciclare | Decor Verde | ShopPrint",
  ...
  "protectia-mediu": {
    ...
    seoTitle: "Tapet ONG Mediu | Decor Ecologic | ShopPrint",
  ...
  "animale": {
    ...
    seoTitle: "Tapet ONG Animale | Decor Prietenos | ShopPrint",
  ...
  "copii": {
    ...
    seoTitle: "Tapet ONG Copii | Decor Inspirational | ShopPrint",
  ...
  "sanatate": {
    ...
    seoTitle: "Tapet ONG Sanatate | Decor Empatic | ShopPrint",
  ...
  "educatie": {
    ...
    seoTitle: "Tapet ONG Educatie | Decor Educational | ShopPrint",
  ...
  "cultura": {
    ...
    seoTitle: "Tapet ONG Cultura | Decor Artistic | ShopPrint",
  ...
  "sport": {
    ...
    seoTitle: "Tapet ONG Sport | Decor Motivational | ShopPrint",
  ...
  "religie": {
    ...
    seoTitle: "Tapet ONG Religie | Decor Spiritual | ShopPrint",
  ...
  "voluntariat": {
    ...
    seoTitle: "Tapet ONG Voluntariat | Decor Inspirational | ShopPrint",
  ...
  "drepturi-om": {
    ...
    seoTitle: "Tapet ONG Drepturi Om | Decor Empatic | ShopPrint",
  ...
  "dezvoltare": {
    ...
    seoTitle: "Tapet ONG Dezvoltare | Decor Inspirational | ShopPrint",
  ...
  "tehnologie": {
    ...
    seoTitle: "Tapet ONG Tehnologie | Decor Futurist | ShopPrint",
  ...
  "arta-si-cultura": {
    ...
    seoTitle: "Tapet ONG Arta si Cultura | Decor Artistic | ShopPrint",
  ...
  "turism-durabil": {
    ...
    seoTitle: "Tapet ONG Turism Durabil | Decor Ecologic | ShopPrint",
  ...
  "alimentatie": {
    ...
    seoTitle: "Tapet ONG Alimentatie | Decor Sustenabil | ShopPrint",
  ...
  "locuinte": {
    ...
    seoTitle: "Tapet ONG Locuinte | Decor Prietenos | ShopPrint",
  ...
  "batrani": {
    ...
    seoTitle: "Tapet ONG Batrani | Decor Empatic | ShopPrint",
  ...
  "handicap": {
    ...
    seoTitle: "Tapet ONG Handicap | Decor Inclusiv | ShopPrint",
  ...
  "femei": {
    ...
    seoTitle: "Tapet ONG Femei | Decor Empatic | ShopPrint",
  ...
  "tineri": {
    ...
    seoTitle: "Tapet ONG Tineri | Decor Inspirational | ShopPrint",
  ...
  "imigranti": {
    ...
    seoTitle: "Tapet ONG Imigranti | Decor Inclusiv | ShopPrint",
  ...
  "dezastre": {
    ...
    seoTitle: "Tapet ONG Dezastre | Decor Inspirational | ShopPrint",
  ...
  "pace": {
    ...
    seoTitle: "Tapet ONG Pace | Decor Empatic | ShopPrint",
  ...
  "democratie": {
    ...
    seoTitle: "Tapet ONG Democratie | Decor Inspirational | ShopPrint",
  ...
  "transparență": {
    ...
    seoTitle: "Tapet ONG Transparenta | Decor Profesional | ShopPrint",
  ...
  "inovatie": {
    ...
    seoTitle: "Tapet ONG Inovatie | Decor Futurist | ShopPrint",
  ...
  "comunitate": {
    ...
    seoTitle: "Tapet ONG Comunitate | Decor Prietenos | ShopPrint",
  ...
  "viitor": {
    ...
    seoTitle: "Tapet ONG Viitor | Decor Inspirational | ShopPrint",
  ...
  "global": {
    ...
    seoTitle: "Tapet ONG Global | Decor Universal | ShopPrint",
  ...
  "sustinabilitate": {
    ...
    seoTitle: "Tapet ONG Sustinabilitate | Decor Verde | ShopPrint",
  ...
  "egalitate": {
    ...
    seoTitle: "Tapet ONG Egalitate | Decor Empatic | ShopPrint",
  ...
  "diversitate": {
    ...
    seoTitle: "Tapet ONG Diversitate | Decor Colorat | ShopPrint",
  ...
  "responsabilitate": {
    ...
    seoTitle: "Tapet ONG Responsabilitate | Decor Inspirational | ShopPrint",
  ...
  "parteneriate": {
    ...
    seoTitle: "Tapet ONG Parteneriate | Decor Colaborativ | ShopPrint",
  ...
  "impact": {
    ...
    seoTitle: "Tapet ONG Impact | Decor Motivational | ShopPrint",
  ...
  "vizibilitate": {
    ...
    seoTitle: "Tapet ONG Vizibilitate | Decor Comunicativ | ShopPrint",
  ...
  "finantare": {
    ...
    seoTitle: "Tapet ONG Finantare | Decor Profesional | ShopPrint",
  ...
  "voluntari": {
    ...
    seoTitle: "Tapet ONG Voluntari | Decor Inspirational | ShopPrint",
  ...
  "campanii": {
    ...
    seoTitle: "Tapet ONG Campanii | Decor Motivational | ShopPrint",
  ...
  "proiecte": {
    ...
    seoTitle: "Tapet ONG Proiecte | Decor Profesional | ShopPrint",
  ...
  "evaluare": {
    ...
    seoTitle: "Tapet ONG Evaluare | Decor Analitic | ShopPrint",
  ...
  "strategie": {
    ...
    seoTitle: "Tapet ONG Strategie | Decor Strategic | ShopPrint",
  ...
  "leadership": {
    ...
    seoTitle: "Tapet ONG Leadership | Decor Inspirational | ShopPrint",
  ...
  "comunicare": {
    ...
    seoTitle: "Tapet ONG Comunicare | Decor Comunicativ | ShopPrint",
  ...
  "tehnologie-ong": {
    ...
    seoTitle: "Tapet ONG Tehnologie | Decor Tech | ShopPrint",
  ...
  "arta-ong": {
    ...
    seoTitle: "Tapet ONG Arta | Decor Artistic | ShopPrint",
  ...
  "social-ong": {
    ...
    seoTitle: "Tapet ONG Social | Decor Empatic | ShopPrint",
  ...
  "cultural-ong": {
    ...
    seoTitle: "Tapet ONG Cultural | Decor Artistic | ShopPrint",
  ...
  "economic-ong": {
    ...
    seoTitle: "Tapet ONG Economic | Decor Profesional | ShopPrint",
  ...
  "politic-ong": {
    ...
    seoTitle: "Tapet ONG Politic | Decor Inspirational | ShopPrint",
  ...
  "international-ong": {
    ...
    seoTitle: "Tapet ONG International | Decor Universal | ShopPrint",
  ...
  "local-ong": {
    ...
    seoTitle: "Tapet ONG Local | Decor Prietenos | ShopPrint",
  ...
  "tineret-ong": {
    ...
    seoTitle: "Tapet ONG Tineret | Decor Inspirational | ShopPrint",
  ...
  "barbati-ong": {
    ...
    seoTitle: "Tapet ONG Barbati | Decor Inspirational | ShopPrint",
  ...
  "familie-ong": {
    ...
    seoTitle: "Tapet ONG Familie | Decor Prietenos | ShopPrint",
