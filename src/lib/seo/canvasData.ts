...
export const CANVAS_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "cadou": {
    ...
    seoTitle: "Tablou Canvas Personalizat | Cadouri Foto | ShopPrint",
  ...
  "nunta": {
    ...
    seoTitle: "Tablou Canvas Nunta | Print Foto Pe Panza | ShopPrint",
  ...
  "botez": {
    ...
    seoTitle: "Tablou Canvas Botez & Bebe | Cadouri Nasi | ShopPrint",
  ...
  "cuplu": {
    ...
    seoTitle: "Tablou Canvas Cuplu | Cadou Valentines Day | ShopPrint",
  ...
  "living": {
    ...
    seoTitle: "Tablouri Living & Sufragerie | Decor Perete | ShopPrint",
  ...
  "dormitor": {
    ...
    seoTitle: "Tablouri Dormitor | Canvas Relaxant | ShopPrint",
  ...
  "bucatarie": {
    ...
    seoTitle: "Tablouri Bucatarie | Decor Perete Dining | ShopPrint",
  ...
  "camera-copii": {
    ...
    seoTitle: "Tablouri Camera Copii | Decor Perete | ShopPrint",
  ...
  "birou": {
    ...
    seoTitle: "Tablouri Birou & Office | Decor Corporate | ShopPrint",
  ...
  "salon": {
    ...
    seoTitle: "Tablouri Salon Infrumusetare & Spa | Decor | ShopPrint",
  ...
  "cabinet-medical": {
    ...
    seoTitle: "Tablouri Cabinet Medical & Sala Asteptare | ShopPrint",
  ...
  "hotel": {
    ...
    seoTitle: "Tablouri Hotel & Horeca | Decor Camere | ShopPrint",
  ...
  "abstract": {
    ...
    seoTitle: "Tablouri Abstracte | Arta Moderna Pe Canvas | ShopPrint",
  ...
  "alb-negru": {
    ...
    seoTitle: "Tablouri Alb Negru | Fotografie Artistica | ShopPrint",
  ...
  "colaj": {
    ...
    seoTitle: "Tablou Colaj Foto | Multe Poze Pe Un Canvas | ShopPrint",
  ...
  "aniversare": {
    ...
    seoTitle: "Tablou Canvas Aniversare | Cadou Personalizat | ShopPrint",
  ...
  "ziua-mamei": {
    ...
    seoTitle: "Tablou Canvas Ziua Mamei | Cadou Emotiv | ShopPrint",
  ...
  "ziua-tatalui": {
    ...
    seoTitle: "Tablou Canvas Ziua Tatalui | Cadou Barbat | ShopPrint",
  ...
  "ziua-copiilor": {
    ...
    seoTitle: "Tablou Canvas Ziua Copiilor | Decor Copii | ShopPrint",
  ...
  "valentine": {
    ...
    seoTitle: "Tablou Canvas Valentine | Cadou Romantic | ShopPrint",
  ...
  "martisor": {
    ...
    seoTitle: "Tablou Canvas Martisor | Traditie Romana | ShopPrint",
  ...
  "paste": {
    ...
    seoTitle: "Tablou Canvas Paste | Sarbatoare Crestina | ShopPrint",
  ...
  "craciun": {
    ...
    seoTitle: "Tablou Canvas Craciun | Decor Festiv | ShopPrint",
  ...
  "revelion": {
    ...
    seoTitle: "Tablou Canvas Revelion | An Nou Fericit | ShopPrint",
  ...
  "hol": {
    ...
    seoTitle: "Tablouri Canvas Hol | Decor Intrare | ShopPrint",
  ...
  "baie": {
    ...
    seoTitle: "Tablouri Canvas Baie | Decor Rezistent | ShopPrint",
  ...
  "balcon": {
    ...
    seoTitle: "Tablouri Canvas Balcon | Decor Exterior | ShopPrint",
  ...
  "gradina": {
    ...
    seoTitle: "Tablouri Canvas Gradina | Decor Exterior | ShopPrint",
  ...
  "restaurant": {
    ...
    seoTitle: "Tablouri Canvas Restaurant | Decor Horeca | ShopPrint",
  ...
  "cafenea": {
    ...
    seoTitle: "Tablouri Canvas Cafenea | Decor Relaxant | ShopPrint",
  ...
  "bar": {
    ...
    seoTitle: "Tablouri Canvas Bar | Decor Vesel | ShopPrint",
  ...
  "receptie-hotel": {
    ...
    seoTitle: "Tablouri Canvas Receptie Hotel | Decor Primitor | ShopPrint",
  ...
  "camera-hotel": {
    ...
    seoTitle: "Tablouri Canvas Camera Hotel | Decor Confortabil | ShopPrint",
  ...
  "spital": {
    ...
    seoTitle: "Tablouri Canvas Spital | Decor Medical | ShopPrint",
  ...
  "scoala": {
    ...
    seoTitle: "Tablouri Canvas Scoala | Decor Educational | ShopPrint",
  ...
  "universitate": {
    ...
    seoTitle: "Tablouri Canvas Universitate | Decor Academic | ShopPrint",
  ...
  "peisaj": {
    ...
    seoTitle: "Tablouri Canvas Peisaj | Natura Pe Perete | ShopPrint",
  ...
  "oras": {
    ...
    seoTitle: "Tablouri Canvas Oras | Arhitectura Urbana | ShopPrint",
  ...
  "animale": {
    ...
    seoTitle: "Tablouri Canvas Animale | Prieteni Patrupede | ShopPrint",
  ...
  "flori": {
    ...
    seoTitle: "Tablouri Canvas Flori | Aranjamente Florale | ShopPrint",
  ...
  "mare": {
    ...
    seoTitle: "Tablouri Canvas Mare | Relaxare Acvatica | ShopPrint",
  ...
  "munte": {
    ...
    seoTitle: "Tablouri Canvas Munte | Aventura Montana | ShopPrint",
  ...
  "minimalist": {
    ...
    seoTitle: "Tablouri Canvas Minimaliste | Design Simplu | ShopPrint",
  ...
  "pop-art": {
    ...
    seoTitle: "Tablouri Canvas Pop Art | Arta Moderna | ShopPrint",
  ...
  "retro": {
    ...
    seoTitle: "Tablouri Canvas Retro | Nostalgie | ShopPrint",
  ...
  "fantasy": {
    ...
    seoTitle: "Tablouri Canvas Fantasy | Lumi Imaginare | ShopPrint",
  ...
  "fotbal": {
    ...
    seoTitle: "Tablouri Canvas Fotbal | Pasiune Sportiva | ShopPrint",
  ...
  "tenis": {
    ...
    seoTitle: "Tablouri Canvas Tenis | Sport Elegant | ShopPrint",
  ...
  "baschet": {
    ...
    seoTitle: "Tablouri Canvas Baschet | Sport Dinamic | ShopPrint",
  ...
  "fitness": {
    ...
    seoTitle: "Tablouri Canvas Fitness | Sanatate si Miscare | ShopPrint",
  ...
  "yoga": {
    ...
    seoTitle: "Tablouri Canvas Yoga | Echilibru Spiritual | ShopPrint",
  ...
  "jazz": {
    ...
    seoTitle: "Tablouri Canvas Jazz | Muzica Improvizata | ShopPrint",
  ...
  "rock": {
    ...
    seoTitle: "Tablouri Canvas Rock | Muzica Rebelă | ShopPrint",
  ...
  "pop": {
    ...
    seoTitle: "Tablouri Canvas Pop | Muzica Populara | ShopPrint",
  ...
  "folk": {
    ...
    seoTitle: "Tablouri Canvas Folk | Traditie Romana | ShopPrint",
  ...
  "opera": {
    ...
    seoTitle: "Tablouri Canvas Opera | Arta Lirica | ShopPrint",
  ...
  "balet": {
    ...
    seoTitle: "Tablouri Canvas Balet | Dans Artistic | ShopPrint",
  ...
  "meditatie": {
    ...
    seoTitle: "Tablouri Canvas Meditatie | Pace Spirituala | ShopPrint",
  ...
  "sanatate": {
    ...
    seoTitle: "Tablouri Canvas Sanatate | Vitalitate | ShopPrint",
  ...
  "ecologie": {
    ...
    seoTitle: "Tablouri Canvas Ecologie | Protectia Mediului | ShopPrint",
  ...
  "padure": {
    ...
    seoTitle: "Tablouri Canvas Padure | Natura Salbatica | ShopPrint",
  ...
  "tech": {
    ...
    seoTitle: "Tablouri Canvas Tech | Inovatie Digitala | ShopPrint",
  ...
  "spatiu": {
    ...
    seoTitle: "Tablouri Canvas Spatiu | Explorare Cosmica | ShopPrint",
  ...
  "motivatii": {
    ...
    seoTitle: "Tablouri Canvas Motivatii | Citat Inspirational | ShopPrint",
  ...
  "familie": {
    ...
    seoTitle: "Tablouri Canvas Familie | Amintiri Dragute | ShopPrint",
  ...
  "prieteni": {
    ...
    seoTitle: "Tablouri Canvas Prieteni | Legaturi Sociale | ShopPrint",
  ...
  "calatorii": {
    ...
    seoTitle: "Tablouri Canvas Calatorii | Aventura Globala | ShopPrint",
  ...
  "culori": {
    ...
    seoTitle: "Tablouri Canvas Culori | Arta Abstracta | ShopPrint",
  ...
  "lumini": {
    ...
    seoTitle: "Tablouri Canvas Lumini | Efecte Magice | ShopPrint",
