...
export const BANNER_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "de-vanzare": {
    ...
    seoTitle: "Banner De Vânzare | Apartamente & Terenuri | ShopPrint",
  ...
  "de-inchiriat": {
    ...
    seoTitle: "Banner De Închiriat | Imobiliare | ShopPrint",
  ...
  "vand-teren": {
    ...
    seoTitle: "Banner Vand Teren | Intravilan & Extravilan | ShopPrint",
  ...
  "spatiu-comercial": {
    ...
    seoTitle: "Banner Spatiu Comercial | Vitrine & Fatade | ShopPrint",
  ...
  "dezvoltator-imobiliar": {
    ...
    seoTitle: "Print Outdoor Dezvoltatori Imobiliari | Mesh & Banner | ShopPrint",
  ...
  "service-auto": {
    ...
    seoTitle: "Banner Service Auto | Reclama Atelier Mecanic | ShopPrint",
  ...
  "vulcanizare": {
    ...
    seoTitle: "Banner Vulcanizare & Roti | Semnalistica Auto | ShopPrint",
  ...
  "itp": {
    ...
    seoTitle: "Banner ITP | Reclama Statie Inspectie Tehnica | ShopPrint",
  ...
  "spalatorie-auto": {
    ...
    seoTitle: "Banner Spalatorie Auto | Self Service | ShopPrint",
  ...
  "piese-auto": {
    ...
    seoTitle: "Banner Piese Auto & Dezmembrari | ShopPrint",
  ...
  "tractari-auto": {
    ...
    seoTitle: "Banner Tractari Auto Non Stop | ShopPrint",
  ...
  "constructii": {
    ...
    seoTitle: "Banner Firma Constructii & Renovari | ShopPrint",
  ...
  "santier-in-lucru": {
    ...
    seoTitle: "Banner Santier in Lucru | Protectia Muncii | ShopPrint",
  ...
  "materiale-constructii": {
    ...
    seoTitle: "Banner Depozit Materiale Constructii | ShopPrint",
  ...
  "amenajari-interioare": {
    ...
    seoTitle: "Banner Amenajari Interioare & Design | ShopPrint",
  ...
  "restaurant": {
    ...
    seoTitle: "Banner Restaurant & Terasa | Outdoor Horeca | ShopPrint",
  ...
  "pizzerie": {
    ...
    seoTitle: "Banner Pizzerie | Livrare Pizza | ShopPrint",
  ...
  "fast-food": {
    ...
    seoTitle: "Banner Fast Food & Shaormerie | ShopPrint",
  ...
  "cafenea": {
    ...
    seoTitle: "Banner Cafenea & Coffe Shop | ShopPrint",
  ...
  "nunti-botezuri": {
    ...
    seoTitle: "Banner Sala Evenimente & Nunti | ShopPrint",
  ...
  "cazare": {
    ...
    seoTitle: "Banner Cazare & Pensiuni | Turism | ShopPrint",
  ...
  "salon-infrumusetare": {
    ...
    seoTitle: "Banner Salon Infrumusetare & Coafor | ShopPrint",
  ...
  "frizerie": {
    ...
    seoTitle: "Banner Frizerie & Barber Shop | ShopPrint",
  ...
  "stomatologie": {
    ...
    seoTitle: "Banner Cabinet Stomatologic & Dentist | ShopPrint",
  ...
  "farmacie": {
    ...
    seoTitle: "Banner Farmacie & Plafar | Semnalistica Medicala | ShopPrint",
  ...
  "veterinar": {
    ...
    seoTitle: "Banner Cabinet Veterinar | Pet Shop | ShopPrint",
  ...
  "magazin-alimentar": {
    ...
    seoTitle: "Banner Magazin Alimentar & Supermarket | ShopPrint",
  ...
  "haine": {
    ...
    seoTitle: "Banner Magazin Haine & Fashion | ShopPrint",
  ...
  "second-hand": {
    ...
    seoTitle: "Banner Second Hand & Outlet | ShopPrint",
  ...
  "florarie": {
    ...
    seoTitle: "Banner Florarie & Aranjamente Florale | ShopPrint",
  ...
  "reparatii-telefoane": {
    ...
    seoTitle: "Banner Service GSM & Reparatii Telefoane | ShopPrint",
  ...
  "amanet": {
    ...
    seoTitle: "Banner Amanet & Schimb Valutar | ShopPrint",
  ...
  "croitorie": {
    ...
    seoTitle: "Banner Croitorie & Retusuri Haine | ShopPrint",
  ...
  "chei": {
    ...
    seoTitle: "Banner Copiat Chei & Lacatus | ShopPrint",
  ...
  "la-multi-ani": {
    ...
    seoTitle: "Banner La Multi Ani Personalizat | Aniversare | ShopPrint",
  ...
  "botez": {
    ...
    seoTitle: "Banner Botez Personalizat | Decor Sala | ShopPrint",
  ...
  "nunta": {
    ...
    seoTitle: "Banner Nunta & Photo Corner | ShopPrint",
  ...
  "black-friday": {
    ...
    seoTitle: "Banner Black Friday | Afise Reduceri | ShopPrint",
  ...
  "sarbatori": {
    ...
    seoTitle: "Banner Sarbatori Fericite | Craciun & Paste | ShopPrint",
  ...
  "primarie": {
    ...
    seoTitle: "Banner Primarie & Institutii Publice | ShopPrint",
  ...
  "biserica": {
    ...
    seoTitle: "Banner Biserica & Parohie | Religios | ShopPrint",
  ...
  "scoala": {
    ...
    seoTitle: "Banner Scoala & Gradinita | Inscrieri | ShopPrint",
  ...
  "agricol": {
    ...
    seoTitle: "Banner Agricol & Produse Locale | ShopPrint",
  ...
  "apicol": {
    ...
    seoTitle: "Banner Miere & Apicultor | ShopPrint",
  ...
  "angajam": {
    ...
    seoTitle: "Banner Angajam Personal | Recrutare | ShopPrint",
  ...
  "deschidere": {
    ...
    seoTitle: "Banner Deschidere Magazin | Grand Opening | ShopPrint",
  ...
  "discount": {
    ...
    seoTitle: "Banner Discount | Reduceri & Promotii | ShopPrint",
  ...
  "promotie": {
    ...
    seoTitle: "Banner Promotie | Campanii Marketing | ShopPrint",
  ...
  "publicitate": {
    ...
    seoTitle: "Banner Publicitate | Reclama Outdoor | ShopPrint",
  ...
  "firma": {
    ...
    seoTitle: "Banner Firma | Prezentare Companie | ShopPrint",
  ...
  "startup": {
    ...
    seoTitle: "Banner Startup | Afaceri Inovatoare | ShopPrint",
  ...
  "franciza": {
    ...
    seoTitle: "Banner Franciza | Extindere Business | ShopPrint",
  ...
  "reparatii": {
    ...
    seoTitle: "Banner Reparatii | Service Tehnic | ShopPrint",
  ...
  "instalatii": {
    ...
    seoTitle: "Banner Instalatii | Electricitate & Sanitara | ShopPrint",
  ...
  "curatenie": {
    ...
    seoTitle: "Banner Curatenie | Servicii Menaj | ShopPrint",
  ...
  "transport": {
    ...
    seoTitle: "Banner Transport | Mutari & Livrari | ShopPrint",
  ...
  "consultanta": {
    ...
    seoTitle: "Banner Consultanta | Expertiza Profesionala | ShopPrint",
  ...
  "avocat": {
    ...
    seoTitle: "Banner Avocat | Servicii Juridice | ShopPrint",
  ...
  "medic": {
    ...
    seoTitle: "Banner Medic | Servicii Medicale | ShopPrint",
  ...
  "universitate": {
    ...
    seoTitle: "Banner Universitate | Admitere & Studii | ShopPrint",
  ...
  "facultate": {
    ...
    seoTitle: "Banner Facultate | Studii Specializate | ShopPrint",
  ...
  "liceu": {
    ...
    seoTitle: "Banner Liceu | Educatie Secundara | ShopPrint",
  ...
  "gimnaziu": {
    ...
    seoTitle: "Banner Gimnaziu | Educatie Gimnaziala | ShopPrint",
  ...
  "gradinita": {
    ...
    seoTitle: "Banner Gradinita | Educatie Prescolara | ShopPrint",
  ...
  "afterschool": {
    ...
    seoTitle: "Banner Afterschool | Meditatii & Hobby | ShopPrint",
  ...
  "meditatii": {
    ...
    seoTitle: "Banner Meditatii | Ajutor Scolar | ShopPrint",
  ...
  "examene": {
    ...
    seoTitle: "Banner Examene | Pregatire Admitere | ShopPrint",
  ...
  "teren": {
    ...
    seoTitle: "Banner Teren | Loturi de Vanzare | ShopPrint",
  ...
  "birou": {
    ...
    seoTitle: "Banner Birou | Spatii Office | ShopPrint",
  ...
  "spatiu-comercial-supl": {
    ...
    seoTitle: "Banner Spatiu Comercial | Magazine & Ateliere | ShopPrint",
  ...
  "depozit": {
    ...
    seoTitle: "Banner Depozit | Stocare Marfa | ShopPrint",
  ...
  "garaj": {
    ...
    seoTitle: "Banner Garaj | Parcari & Boxe | ShopPrint",
  ...
  "schimb": {
    ...
    seoTitle: "Banner Schimb | Imobiliare Schimb | ShopPrint",
  ...
  "donatie": {
    ...
    seoTitle: "Banner Donatie | Ajutor Social | ShopPrint",
  ...
  "voluntariat": {
    ...
    seoTitle: "Banner Voluntariat | Activitati Sociale | ShopPrint",
  ...
  "adoptie": {
    ...
    seoTitle: "Banner Adoptie | Animale & Copii | ShopPrint",
  ...
  "revelion": {
    ...
    seoTitle: "Banner Revelion | Sarbatori An Nou | ShopPrint",
  ...
  "ziua-mamei": {
    ...
    seoTitle: "Banner Ziua Mamei | Sarbatori Familiale | ShopPrint",
  ...
  "ziua-tatalui": {
    ...
    seoTitle: "Banner Ziua Tatalui | Sarbatori Familiale | ShopPrint",
  ...
  "ziua-copiilor": {
    ...
    seoTitle: "Banner Ziua Copiilor | Sarbatori pentru Copii | ShopPrint",
  ...
  "valentine": {
    ...
    seoTitle: "Banner Valentine | Ziua Indragostitilor | ShopPrint",
  ...
  "martisor": {
    ...
    seoTitle: "Banner Martisor | Sarbatoarea Primaverii | ShopPrint",
  ...
  "ziua-nationala": {
    ...
    seoTitle: "Banner Ziua Nationala | Sarbatori Patriotice | ShopPrint",
  ...
  "fotbal": {
    ...
    seoTitle: "Banner Fotbal | Cluburi & Meciuri | ShopPrint",
  ...
  "baschet": {
    ...
    seoTitle: "Banner Baschet | Echipe & Campionate | ShopPrint",
  ...
  "volei": {
    ...
    seoTitle: "Banner Volei | Echipe & Meciuri | ShopPrint",
  ...
  "handbal": {
    ...
    seoTitle: "Banner Handbal | Campionate & Goluri | ShopPrint",
  ...
  "atletism": {
    ...
    seoTitle: "Banner Atletism | Competitii & Recorduri | ShopPrint",
  ...
  "gimnastica": {
    ...
    seoTitle: "Banner Gimnastica | Sali & Competitii | ShopPrint",
  ...
  "jazz": {
    ...
    seoTitle: "Banner Jazz | Concerte & Festivaluri | ShopPrint",
  ...
  "rock": {
    ...
    seoTitle: "Banner Rock | Concerte & Festivaluri | ShopPrint",
  ...
  "pop": {
    ...
    seoTitle: "Banner Pop | Concerte & Show-uri | ShopPrint",
  ...
  "folk": {
    ...
    seoTitle: "Banner Folk | Muzica Traditionala | ShopPrint",
  ...
  "opera": {
    ...
    seoTitle: "Banner Opera | Spectacole Clasice | ShopPrint",
  ...
  "balet": {
    ...
    seoTitle: "Banner Balet | Spectacole de Dans | ShopPrint",
  ...
  "pictura": {
    ...
    seoTitle: "Banner Pictura | Expozitii Artistice | ShopPrint",
  ...
  "sculptura": {
    ...
    seoTitle: "Banner Sculptura | Arta 3D | ShopPrint",
  ...
  "fotografie": {
    ...
    seoTitle: "Banner Fotografie | Expozitii & Portrete | ShopPrint",
  ...
  "film": {
    ...
    seoTitle: "Banner Film | Festivaluri & Proiectii | ShopPrint",
  ...
  "conferinta-tech": {
    ...
    seoTitle: "Banner Conferinta Tech | Tehnologie & Inovare | ShopPrint",
  ...
  "hackathon": {
    ...
    seoTitle: "Banner Hackathon | Competitii Coding | ShopPrint",
  ...
  "startup-pitch": {
    ...
    seoTitle: "Banner Startup Pitch | Afaceri Inovatoare | ShopPrint",
  ...
  "vaccin": {
    ...
    seoTitle: "Banner Vaccin | Campanii de Imunizare | ShopPrint",
  ...
  "donare-sange": {
    ...
    seoTitle: "Banner Donare Sange | Acte de Binefacere | ShopPrint",
  ...
  "campanie-preventie": {
    ...
    seoTitle: "Banner Campanie Preventie | Sanatate Publica | ShopPrint",
  ...
  "fitness": {
    ...
    seoTitle: "Banner Fitness | Sali Sport & Antrenamente | ShopPrint",
  ...
  "yoga": {
    ...
    seoTitle: "Banner Yoga | Relaxare & Meditatie | ShopPrint",
  ...
  "ecologie": {
    ...
    seoTitle: "Banner Ecologie | Mediu & Protectie | ShopPrint",
  ...
  "reciclare": {
    ...
    seoTitle: "Banner Reciclare | Protectia Mediului | ShopPrint",
  ...
  "protejarea-mediului": {
    ...
    seoTitle: "Banner Protejarea Mediului | Ecologie & Actiune | ShopPrint",
  ...
  "fundatie": {
    ...
    seoTitle: "Banner Fundatie | Activitati Caritabile | ShopPrint",
  ...
  "ong": {
    ...
    seoTitle: "Banner ONG | Activitati Sociale | ShopPrint",
  ...
  "ajutor-umanitar": {
    ...
    seoTitle: "Banner Ajutor Umanitar | Sprijin Social | ShopPrint",
