...
export const AUTOCOLANTE_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "auto": {
    ...
    seoTitle: "Autocolante Auto | Branding Masini & Flote | ShopPrint",
  ...
  "taxi": {
    ...
    seoTitle: "Autocolante Taxi | Tarife & Ecusoane | ShopPrint",
  ...
  "uber-bolt": {
    ...
    seoTitle: "Autocolante Uber & Bolt | Ridesharing | ShopPrint",
  ...
  "baby-on-board": {
    ...
    seoTitle: "Sticker Baby on Board Personalizat | ShopPrint",
  ...
  "scoala-soferi": {
    ...
    seoTitle: "Autocolante Scoala de Soferi | Casete Taxi | ShopPrint",
  ...
  "moto": {
    ...
    seoTitle: "Stickere Moto & ATV | Grafica Personalizata | ShopPrint",
  ...
  "vitrina": {
    ...
    seoTitle: "Autocolant Vitrina Magazin | Window Graphics | ShopPrint",
  ...
  "program": {
    ...
    seoTitle: "Sticker Program Functionare | Orar Magazin | ShopPrint",
  ...
  "reduceri": {
    ...
    seoTitle: "Stickere Reduceri & Soldari | Decor Vitrina | ShopPrint",
  ...
  "sarbatori": {
    ...
    seoTitle: "Stickere Craciun & Paste | Decor Vitrine | ShopPrint",
  ...
  "floor-graphics": {
    ...
    seoTitle: "Autocolant Podea | Floor Graphics Antiderapant | ShopPrint",
  ...
  "etichete-produse": {
    ...
    seoTitle: "Etichete Produse Personalizate | Rola & Coala | ShopPrint",
  ...
  "etichete-borcane": {
    ...
    seoTitle: "Etichete Borcane Miere & Dulceata | Autocolante | ShopPrint",
  ...
  "etichete-sticle": {
    ...
    seoTitle: "Etichete Sticle Vin & Bauturi | Personalizate | ShopPrint",
  ...
  "delivery": {
    ...
    seoTitle: "Etichete Delivery & Sigiliu Mancare | ShopPrint",
  ...
  "marturii": {
    ...
    seoTitle: "Etichete Marturii Nunta & Botez | Sticker Rotund | ShopPrint",
  ...
  "ssm": {
    ...
    seoTitle: "Autocolante SSM & Protectia Muncii | Semne Obligatorii | ShopPrint",
  ...
  "supraveghere-video": {
    ...
    seoTitle: "Sticker Supraveghere Video & CCTV | GDPR | ShopPrint",
  ...
  "interzis-fumatul": {
    ...
    seoTitle: "Sticker Interzis Fumatul | Semnalistica | ShopPrint",
  ...
  "toaleta": {
    ...
    seoTitle: "Stickere Toaleta & WC | Semnalistica Usi | ShopPrint",
  ...
  "reciclare": {
    ...
    seoTitle: "Etichete Reciclare & Colectare Selectiva | ShopPrint",
  ...
  "perete": {
    ...
    seoTitle: "Stickere Perete Decorative | Wall Art | ShopPrint",
  ...
  "mobila": {
    ...
    seoTitle: "Autocolant Mobila & Usi | Reconditionare | ShopPrint",
  ...
  "camera-copii": {
    ...
    seoTitle: "Stickere Camera Copii & Bebe | Decor | ShopPrint",
  ...
  "laptop": {
    ...
    seoTitle: "Stickere Laptop & Skinuri | Personalizate | ShopPrint",
  ...
  "bmw": {
    ...
    seoTitle: "Stickere BMW | Logo Masina | ShopPrint",
  ...
  "audi": {
    ...
    seoTitle: "Stickere Audi | Embleme Masina | ShopPrint",
  ...
  "mercedes": {
    ...
    seoTitle: "Stickere Mercedes | Stea Masina | ShopPrint",
  ...
  "volkswagen": {
    ...
    seoTitle: "Stickere Volkswagen | Logo VW | ShopPrint",
  ...
  "ford": {
    ...
    seoTitle: "Stickere Ford | Oval Masina | ShopPrint",
  ...
  "renault": {
    ...
    seoTitle: "Stickere Renault | Diamant Masina | ShopPrint",
  ...
  "dacia": {
    ...
    seoTitle: "Stickere Dacia | Logo Romanesc | ShopPrint",
  ...
  "opel": {
    ...
    seoTitle: "Stickere Opel | Fulger Masina | ShopPrint",
  ...
  "peugeot": {
    ...
    seoTitle: "Stickere Peugeot | Leu Masina | ShopPrint",
  ...
  "citroen": {
    ...
    seoTitle: "Stickere Citroen | Chevron Masina | ShopPrint",
  ...
  "fiat": {
    ...
    seoTitle: "Stickere Fiat | Logo Italian | ShopPrint",
  ...
  "skoda": {
    ...
    seoTitle: "Stickere Skoda | Sageata Masina | ShopPrint",
  ...
  "toyota": {
    ...
    seoTitle: "Stickere Toyota | Logo Japonez | ShopPrint",
  ...
  "honda": {
    ...
    seoTitle: "Stickere Honda | H Masina | ShopPrint",
  ...
  "nissan": {
    ...
    seoTitle: "Stickere Nissan | Logo Japonez | ShopPrint",
  ...
  "hyundai": {
    ...
    seoTitle: "Stickere Hyundai | H Masina | ShopPrint",
  ...
  "kia": {
    ...
    seoTitle: "Stickere Kia | Logo Coreean | ShopPrint",
  ...
  "volvo": {
    ...
    seoTitle: "Stickere Volvo | Grila Masina | ShopPrint",
  ...
  "tesla": {
    ...
    seoTitle: "Stickere Tesla | Logo Electric | ShopPrint",
  ...
  "custom-auto": {
    ...
    seoTitle: "Stickere Auto Personalizate | Design Unic | ShopPrint",
  ...
  "numere-auto": {
    ...
    seoTitle: "Stickere Numere Auto | Placute Personalizate | ShopPrint",
  ...
  "parcare": {
    ...
    seoTitle: "Stickere Parcare | Rezervat Handicap | ShopPrint",
  ...
  "ecusoane-politie": {
    ...
    seoTitle: "Ecusoane Politie | Autocolante Oficiale | ShopPrint",
  ...
  "ambulanta": {
    ...
    seoTitle: "Stickere Ambulanta | Semnalizare Medicala | ShopPrint",
  ...
  "pompieri": {
    ...
    seoTitle: "Autocolante Pompieri | Logo Masina | ShopPrint",
  ...
  "logo-firma": {
    ...
    seoTitle: "Stickere Logo Firma | Branding Corporate | ShopPrint",
  ...
  "qr-code": {
    ...
    seoTitle: "Stickere QR Code | Marketing Digital | ShopPrint",
  ...
  "slogan": {
    ...
    seoTitle: "Stickere Slogan | Mesaje Motivante | ShopPrint",
  ...
  "nume-firma": {
    ...
    seoTitle: "Stickere Nume Firma | Identitate Vizuala | ShopPrint",
  ...
  "contact": {
    ...
    seoTitle: "Stickere Contact | Telefon Email | ShopPrint",
  ...
  "preturi": {
    ...
    seoTitle: "Stickere Preturi | Etichete Promotionale | ShopPrint",
  ...
  "reclama": {
    ...
    seoTitle: "Stickere Reclama | Promovare Produse | ShopPrint",
  ...
  "petrecere": {
    ...
    seoTitle: "Stickere Petrecere | Invitatii Decor | ShopPrint",
  ...
  "nunta": {
    ...
    seoTitle: "Stickere Nunta | Decor Personalizare | ShopPrint",
  ...
  "botez": {
    ...
    seoTitle: "Stickere Botez | Decor Religios | ShopPrint",
  ...
  "aniversare": {
    ...
    seoTitle: "Stickere Aniversare | Decor Cadouri | ShopPrint",
  ...
  "ziua-copiilor": {
    ...
    seoTitle: "Stickere Ziua Copiilor | Decor Activitati | ShopPrint",
  ...
  "halloween": {
    ...
    seoTitle: "Stickere Halloween | Decor Infricosator | ShopPrint",
  ...
  "craciun": {
    ...
    seoTitle: "Stickere Craciun | Decor Festiv | ShopPrint",
  ...
  "paste": {
    ...
    seoTitle: "Stickere Paste | Decor Traditional | ShopPrint",
  ...
  "revelion": {
    ...
    seoTitle: "Stickere Revelion | Decor An Nou | ShopPrint",
  ...
  "valentine": {
    ...
    seoTitle: "Stickere Valentine | Decor Romantic | ShopPrint",
  ...
  "martisor": {
    ...
    seoTitle: "Stickere Martisor | Decor Traditional | ShopPrint",
  ...
  "ziua-mamei": {
    ...
    seoTitle: "Stickere Ziua Mamei | Decor Afectuos | ShopPrint",
  ...
  "ziua-tatalui": {
    ...
    seoTitle: "Stickere Ziua Tatalui | Decor Puternic | ShopPrint",
  ...
  "ziua-nationala": {
    ...
    seoTitle: "Stickere Ziua Nationala | Decor Patriotic | ShopPrint",
  ...
  "scoala": {
    ...
    seoTitle: "Stickere Scoala | Etichete Decor | ShopPrint",
  ...
  "universitate": {
    ...
    seoTitle: "Stickere Universitate | Branding Academic | ShopPrint",
  ...
  "meditatii": {
    ...
    seoTitle: "Stickere Meditatii | Etichete Materii | ShopPrint",
  ...
  "cursuri": {
    ...
    seoTitle: "Stickere Cursuri | Branding Educational | ShopPrint",
  ...
  "examene": {
    ...
    seoTitle: "Stickere Examene | Etichete Motivante | ShopPrint",
  ...
  "medic": {
    ...
    seoTitle: "Stickere Medic | Etichete Medicale | ShopPrint",
  ...
  "vaccin": {
    ...
    seoTitle: "Stickere Vaccin | Etichete Preventie | ShopPrint",
  ...
  "donare-sange": {
    ...
    seoTitle: "Stickere Donare Sange | Campanii Umanitare | ShopPrint",
  ...
  "fitness": {
    ...
    seoTitle: "Stickere Fitness | Branding Sala | ShopPrint",
  ...
  "yoga": {
    ...
    seoTitle: "Stickere Yoga | Etichete Calmante | ShopPrint",
  ...
  "fotbal": {
    ...
    seoTitle: "Stickere Fotbal | Logo Echipa | ShopPrint",
  ...
  "baschet": {
    ...
    seoTitle: "Stickere Baschet | Branding Sportiv | ShopPrint",
  ...
  "tenis": {
    ...
    seoTitle: "Stickere Tenis | Logo Branding | ShopPrint",
  ...
  "atletism": {
    ...
    seoTitle: "Stickere Atletism | Simboluri Olimpice | ShopPrint",
  ...
  "rock": {
    ...
    seoTitle: "Stickere Rock | Chitari Logo | ShopPrint",
  ...
  "pop": {
    ...
    seoTitle: "Stickere Pop | Stele Culori | ShopPrint",
  ...
  "jazz": {
    ...
    seoTitle: "Stickere Jazz | Note Muzicale | ShopPrint",
  ...
  "folk": {
    ...
    seoTitle: "Stickere Folk | Instrumente Traditionale | ShopPrint",
  ...
  "apple": {
    ...
    seoTitle: "Stickere Apple | Logo Branding | ShopPrint",
  ...
  "samsung": {
    ...
    seoTitle: "Stickere Samsung | Logo Coreean | ShopPrint",
  ...
  "gaming": {
    ...
    seoTitle: "Stickere Gaming | Logo Jocuri | ShopPrint",
  ...
  "programare": {
    ...
    seoTitle: "Stickere Programare | Cod Logo | ShopPrint",
  ...
  "citate": {
    ...
    seoTitle: "Stickere Citate | Motivante Inspirante | ShopPrint",
  ...
  "animale": {
    ...
    seoTitle: "Stickere Animale | Personaje Dragute | ShopPrint",
  ...
  "flori": {
    ...
    seoTitle: "Stickere Flori | Decor Natural | ShopPrint",
  ...
  "stelute": {
    ...
    seoTitle: "Stickere Stelute | Decor Astral | ShopPrint",
  ...
  "pericol": {
    ...
    seoTitle: "Stickere Pericol | Semnalizare SSM | ShopPrint",
  ...
  "iesire": {
    ...
    seoTitle: "Stickere Iesire Urgenta | Semnalizare | ShopPrint",
  ...
  "prim-ajutor": {
    ...
    seoTitle: "Stickere Prim Ajutor | Truse Medicale | ShopPrint",
  ...
  "organic": {
    ...
    seoTitle: "Stickere Organic | Etichete Produse | ShopPrint",
  ...
  "vegan": {
    ...
    seoTitle: "Stickere Vegan | Etichete Alimentare | ShopPrint",
  ...
  "fara-gluten": {
    ...
    seoTitle: "Stickere Fara Gluten | Etichete Speciale | ShopPrint",
  ...
  "nume": {
    ...
    seoTitle: "Stickere Nume Personalizate | Branding | ShopPrint",
  ...
  "initiale": {
    ...
    seoTitle: "Stickere Initiale | Monograme | ShopPrint",
  ...
  "emoji": {
    ...
    seoTitle: "Stickere Emoji | Expresii Veselé | ShopPrint",
