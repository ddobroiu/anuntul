...
export const PVC_FOREX_DATA: Record<string, LandingInfo> = {
  "panou-publicitar": {
    ...
    seoTitle: "Panouri Publicitare PVC Forex | Print UV Direct | ShopPrint",
  ...
  "tablou": {
    ...
    seoTitle: "Tablouri Forex & Multicanvas Rigid | Decor | ShopPrint",
  ...
  "semnalistica": {
    ...
    seoTitle: "Semnalistica Interioara PVC | Placute Usi | ShopPrint",
  ...
  "meniu-rigid": {
    ...
    seoTitle: "Meniu Restaurant Rigid | Placa PVC | ShopPrint",
  ...
  "panou-afisaj": {
    ...
    seoTitle: "Panou Afisaj PVC Forex | Print UV | ShopPrint",
  ...
  "tablou-decorativ": {
    ...
    seoTitle: "Tablou Decorativ PVC | Artă Modernă | ShopPrint",
  ...
  "semnalistica-exterior": {
    ...
    seoTitle: "Semnalistica Exterior PVC | Indicatoare | ShopPrint",
  ...
  "meniu-bar": {
    ...
    seoTitle: "Meniu Bar PVC Rigid | Print Profesional | ShopPrint",
  ...
  "panou-eveniment": {
    ...
    seoTitle: "Panou Eveniment PVC | Afișaj Rigid | ShopPrint",
  ...
  "tablou-personalizat": {
    ...
    seoTitle: "Tablou Personalizat PVC | Foto Rigid | ShopPrint",
  ...
  "semnalistica-birou": {
    ...
    seoTitle: "Semnalistica Birou PVC | Placute Profesionale | ShopPrint",
  ...
  "meniu-cafenea": {
    ...
    seoTitle: "Meniu Cafenea PVC | Print Ieftin | ShopPrint",
  ...
  "panou-promotional": {
    ...
    seoTitle: "Panou Promotional PVC | Reclama Rigid | ShopPrint",
  ...
  "tablou-arta": {
    ...
    seoTitle: "Tablou Arta PVC | Reproduceri | ShopPrint",
...
export const PLEXIGLASS_DATA: Record<string, LandingInfo> = {
  "placa-firma": {
    ...
    seoTitle: "Placuta Firma Plexiglass | Sigla Cabinet | ShopPrint",
  ...
  "protectie-birou": {
    ...
    seoTitle: "Panou Protectie Plexiglass | Separator Birou | ShopPrint",
  ...
  "litere-plexiglass": {
    ...
    seoTitle: "Litere Volumetrice Plexiglass | Sigle 3D | ShopPrint",
  ...
  "placa-firma-transparenta": {
    ...
    seoTitle: "Placa Firma Transparenta | Plexiglass Modern | ShopPrint",
  ...
  "protectie-covid": {
    ...
    seoTitle: "Panou Protectie COVID | Separator Transparent | ShopPrint",
  ...
  "litere-illuminated": {
    ...
    seoTitle: "Litere Iluminate Plexiglass | Sigle LED | ShopPrint",
  ...
  "placa-nume": {
    ...
    seoTitle: "Placa Nume Plexiglass | Identificare | ShopPrint",
  ...
  "separator-birou": {
    ...
    seoTitle: "Separator Birou Transparent | Open Space | ShopPrint",
  ...
  "litere-firma": {
    ...
    seoTitle: "Litere Firma Plexiglass | Branding 3D | ShopPrint",
  ...
  "placa-adresa": {
    ...
    seoTitle: "Placa Adresa Plexiglass | Identificare | ShopPrint",
  ...
  "protectie-receptie": {
    ...
    seoTitle: "Panou Protectie Receptie | Plexiglass | ShopPrint",
  ...
  "litere-decorative": {
    ...
    seoTitle: "Litere Decorative Plexiglass | Arta | ShopPrint",
  ...
  "placa-program": {
    ...
    seoTitle: "Placa Program Plexiglass | Orar | ShopPrint",
...
export const ALUCOBOND_DATA: Record<string, LandingInfo> = {
  "fatada": {
    ...
    seoTitle: "Print Alucobond & Dibond | Panouri Fatada | ShopPrint",
  ...
  "panou-santier": {
    ...
    seoTitle: "Panou Santier Rezistent | Alucobond | ShopPrint",
  ...
  "tablou-bond": {
    ...
    seoTitle: "Print Pe Metal & Aluminiu | Tablouri Bond | ShopPrint",
  ...
  "fatada-luminoasa": {
    ...
    seoTitle: "Fatada Luminoasa Alucobond | LED | ShopPrint",
  ...
  "panou-reclama": {
    ...
    seoTitle: "Panou Reclama Alucobond | Exterior | ShopPrint",
  ...
  "tablou-metalic": {
    ...
    seoTitle: "Tablou Metalic Alucobond | Decor Modern | ShopPrint",
  ...
  "fatada-corporate": {
    ...
    seoTitle: "Fatada Corporate Alucobond | Branding | ShopPrint",
  ...
  "panou-eveniment-exterior": {
    ...
    seoTitle: "Panou Eveniment Exterior | Alucobond | ShopPrint",
  ...
  "tablou-architectural": {
    ...
    seoTitle: "Tablou Architectural Alucobond | Arta | ShopPrint",
  ...
  "fatada-magazin": {
    ...
    seoTitle: "Fatada Magazin Alucobond | Reclama | ShopPrint",
  ...
  "panou-informativ": {
    ...
    seoTitle: "Panou Informativ Alucobond | Ghidare | ShopPrint",
  ...
  "tablou-industrial": {
    ...
    seoTitle: "Tablou Industrial Alucobond | Decor | ShopPrint",
  ...
  "fatada-restaurant": {
    ...
    seoTitle: "Fatada Restaurant Alucobond | Branding | ShopPrint",
...
export const POLIPROPILENA_DATA: Record<string, LandingInfo> = {
  "imobiliare": {
    ...
    seoTitle: "Panouri Imobiliare Polipropilena | VAND / INCHIRIEZ | ShopPrint",
  ...
  "saget": {
    ...
    seoTitle: "Sageti directionale Polipropilena | Semne Usoare | ShopPrint",
  ...
  "imobiliare-vand": {
    ...
    seoTitle: "Panouri Vand Imobiliare | Polipropilena | ShopPrint",
  ...
  "saget-eveniment": {
    ...
    seoTitle: "Sageti Eveniment Polipropilena | Ghidare | ShopPrint",
  ...
  "imobiliare-inchiriez": {
    ...
    seoTitle: "Panouri Inchiriez Polipropilena | Imobiliare | ShopPrint",
  ...
  "saget-parcare": {
    ...
    seoTitle: "Sageti Parcare Polipropilena | Directie | ShopPrint",
  ...
  "imobiliare-teren": {
    ...
    seoTitle: "Panouri Teren Polipropilena | Vand Teren | ShopPrint",
  ...
  "saget-construcție": {
    ...
    seoTitle: "Sageti Constructie Polipropilena | Santier | ShopPrint",
  ...
  "imobiliare-apartament": {
    ...
    seoTitle: "Panouri Apartament Polipropilena | Vand | ShopPrint",
  ...
  "saget-eveniment-sportiv": {
    ...
    seoTitle: "Sageti Sport Polipropilena | Eveniment | ShopPrint",
  ...
  "imobiliare-casa": {
    ...
    seoTitle: "Panouri Casa Polipropilena | Vand Casa | ShopPrint",
  ...
  "saget-targ": {
    ...
    seoTitle: "Sageti Targ Polipropilena | Expo | ShopPrint",
...
export const CARTON_DATA: Record<string, LandingInfo> = {
  "standee": {
    ...
    seoTitle: "Figurine Carton & Standee | Cutout Personaje | ShopPrint",
  ...
  "panou-nunta": {
    ...
    seoTitle: "Panou Welcome Nunta | Carton rigid | ShopPrint",
  ...
  "standee-personaj": {
    ...
    seoTitle: "Standee Personaj Carton | Cutout | ShopPrint",
  ...
  "panou-botez": {
    ...
    seoTitle: "Panou Botez Carton | Welcome | ShopPrint",
  ...
  "standee-mascota": {
    ...
    seoTitle: "Standee Mascota Carton | Branding | ShopPrint",
  ...
  "panou-aniversare": {
    ...
    seoTitle: "Panou Aniversare Carton | Sărbătoare | ShopPrint",
  ...
  "standee-superstar": {
    ...
    seoTitle: "Standee Superstar Carton | Celebritate | ShopPrint",
  ...
  "panou-graduation": {
    ...
    seoTitle: "Panou Absolvire Carton | Diplomă | ShopPrint",
  ...
  "standee-eroi": {
    ...
    seoTitle: "Standee Eroi Carton | Patriotism | ShopPrint",
  ...
  "panou-promovare": {
    ...
    seoTitle: "Panou Promovare Carton | Reclama | ShopPrint",
  ...
  "standee-animale": {
    ...
    seoTitle: "Standee Animale Carton | Natură | ShopPrint",
  ...
  "panou-festival": {
    ...
    seoTitle: "Panou Festival Carton | Eveniment | ShopPrint",
