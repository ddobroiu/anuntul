                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="bg-slate-900 text-white p-8 rounded-lg mb-8 sticky top-24">
                            <ul className="space-y-4 text-slate-100 leading-relaxed">
                                <li>Valoarea totală a proiectului 187.457,46 lei</li>
                                <li>Valoarea maximă a finanțării nerambursabile din PNRR 140.160,60 lei</li>
                                <li>Cofinanțare beneficiar aferentă cheltuielilor eligibile 15.573,40 lei</li>
                                <li>Valoarea totală neeligibilă 31.723,46 lei</li>
                            </ul>
                        </div>
