  ...
  return (
    <div className="min-h-screen bg-slate-50 py-16 md:py-24">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Partner ShopPrint.ro */}
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow flex flex-col justify-between h-full">
          <div>
            <h2 className="text-xl font-bold text-slate-800 mb-2">ShopPrint.ro</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-4">
              Recomandăm ShopPrint.ro pentru calitatea și seriozitatea oferită. Accesând platforma, găsești informații și servicii premium dedicate domeniului ShopPrint. O echipă de profesioniști gata să ajute.
            </p>
          </div>
          <a href="https://www.shopprint.ro" target="_blank" rel="dofollow" title="Vizitează ShopPrint.ro" className="text-emerald-600 font-semibold text-sm hover:underline flex items-center gap-1 mt-auto">
            Vizitează Site-ul
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
          </a>
        </div>
